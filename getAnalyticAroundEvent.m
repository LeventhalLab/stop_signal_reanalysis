function ansig = getAnalyticAroundEvent( ch, freqIdx, eventName, trialType, twin, varargin )
%
...
%     iTr
    ...
    ansig(numValidTrials, :) = readAnalyticSignal(hilbert_name, metadata, tlim, freqIdx);
