function extractGregLFPbyChannels(channels, varargin)
...
for iSession = 71 : numSessions
    ...
    [pn, HSDfn, ext, versn] = fileparts(hsdName);
    ...
    parfor iCh = 1 : numLFPchannels
        currentLFP(iCh, :) = ...
            decimate(activeHSD(iCh, :), r, filtOrder, 'fir');
    end
