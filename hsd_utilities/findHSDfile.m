...
%             dirString = fullfile('/Volumes','dan','Recording data','IM-149_DL-03','IM-149_DL-03_hsd');
        ...
        case 'IM-164',
            dirString = fullfile('/Volumes','dan-nas3','Recording data','IM-164_DL-22','IM-164_DL-22_hsd');
        case 'IM-166',
            dirString = fullfile('/Volumes','dan-nas3','Recording data','IM-166_DL-20','IM-166_DL-20_hsd');
        case 'IM-174',
            dirString = fullfile('/Volumes','dan-nas3','Recording data','IM-174_DL-24','IM-174_DL-24_hsd');
        case 'IM-225',
