...
phaseRTcorr_directory = fullfile(rootNasDir, 'PublicLeventhal1\dan\stop-signal reanalysis\phase_RT_correlations_circstat');
...
for i_chDB = 8 : 8%length(chDB_list)-1
