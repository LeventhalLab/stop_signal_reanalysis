% script_phaseAmp_surrogates_byTrial_t_mrl_20140324c
...
for i_chDB = 2 : 4%length(chDB_list)
    ...
    for iTrialType = 7:7%startTrialType:6%startTrialType : length(trialTypeList)
...
%             skip(find(skip<minSkip))=[];
            ...
            for iCh = numCh-3:numCh-3%1 : numCh
