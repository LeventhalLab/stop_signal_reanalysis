...
hilbert_025Hz_directory = fullfile(rootNasDir, 'PublicLeventhal1\dan\stop-signal reanalysis\Hilbert transformed LFP 025 Hz bins');
...
for i_chDB = 4 : length(chDB_list)
    ...
    for iTrialType = 3 : length(trialTypeList)
