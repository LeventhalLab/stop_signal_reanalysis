...
for i_chDB = 3 : 3%length(chDB_list)
    ...
    for iTrialType = 2 : length(trialTypeList)                  % NOTE STARTING WITH 2 TO CHECK THAT IT WORKS...
...
%             numSteps = length(winStartTimes);    %floor((range(eventtWin) - analysisWin) / stepSize) + 1;
            ...
            for iCh = 1 : numCh
                ...
                [MI, low_freqs, high_freqs] = mean_phase_amp_comodugram(ch, ...
                ...
                save(phaseAmp_name, 'MI', 'phaseAmp_metadata');
