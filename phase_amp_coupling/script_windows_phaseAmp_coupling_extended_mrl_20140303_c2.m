% script_windows_phaseAmp_coupling_extended_mrl_20140303_c2
...
%         phaseAmp_metadata.stepSize        = stepSize(iTrialType);
    ...
    %             error([metadata_filename ' could not be found.']);
            ...
            for iCh = 1 : numCh
                ...
                [mrv2, low_freqs, high_freqs] = phase_amp_Canolty_MI_20140303(ch, ...
                ...
                for iEventType = 1 : numEventTypes
                    for i_f1 = low_freq_startIdx : num_lowFreqs
                        ...
                        mrv(iEventType, i_f1, :, :) = squeeze(mrv2(new_f1, :, :));
                    end
                end
