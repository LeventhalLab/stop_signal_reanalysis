...
lfp_root          = '\\141.214.45.212\PublicLeventhal1\dan\stop-signal reanalysis\stop-signal LFPs';
saveDir           = '\\141.214.45.212\PublicLeventhal1\dan\stop-signal reanalysis\all_LFP_plots';
...
for i_chDB = 9 : length(chDB_list)
    ...
    base_saveName = fullfile(saveDir, base_saveName);
