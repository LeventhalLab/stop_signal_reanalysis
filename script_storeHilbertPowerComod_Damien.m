...
chDB_directory    = '/Volumes/PublicLeventhal1-1/dan/stop-signal reanalysis/stop-signal data structures';
hilbert_directory = '/Volumes/PublicLeventhal1-1/dan/stop-signal reanalysis/Hilbert transformed LFP 1 Hz bins';
comod_directory = '/Volumes/PublicLeventhal1-1/dan/stop-signal reanalysis/power-power comodugrams';

[chDB_list, chDB_fnames] = get_chStructs_for_analysis;

for i_chDB = 3 : 1 : length(chDB_list)
