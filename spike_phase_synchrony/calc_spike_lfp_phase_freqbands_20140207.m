function [plv, ppc, numSpikes, spikePhases, freqList, numEvents] = calc_spike_lfp_phase_freqbands_20140207( ch, sp_ts, trialType, eventList, eventWin, spikeWin, stepSize, varargin )
%
% usage: 
%
% INPUTS:
...
plv = zeros(numEventTypes, numFreqs, numSteps);
tic
...
iEventType
        for iStep = 1 : numSteps
            ...
            plv(iEventType, iFreq, iStep) = abs(sum(exp(1i*spikePhases{iEventType, iFreq, iStep}))) / ...
                                            length(spikePhases{iEventType, iFreq, iStep});
                                        
            ppc(iEventType, iFreq, iStep) = calc_ppc_20140923(spikePhases{iEventType, iFreq, iStep});
