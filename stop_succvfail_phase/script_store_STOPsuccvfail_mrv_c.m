% script_store_STOPsuccvfail_mrv_c
...
for i_chDB = 3 : 3%length(chDB_list)
    ...
    for iSession = 1 : numSessions                          % change this back to 1 when done
...
%             mrvDiff_by_region = cell(1, numRegions);
        ...
        for iRegion = 1 : numRegions % STOPmrv_metadata.num_regions_complete + 1 : numRegions
            cp = initChanParams();
