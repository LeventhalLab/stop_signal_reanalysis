% script_store_STOPsuccvfail_mrv_surrogates_gabor
...
for i_chDB = 1 : 4%length(chDB_list)
    ...
    for iSession = 1 : numSessions
        ...
        surr_STOPmrv_metadata.f = STOPmetadata.f;
        ...
        mrvDiff = zeros(numEventTypes, numSamps, numFreqs);
