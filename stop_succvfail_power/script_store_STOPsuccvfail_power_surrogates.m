% script_store_STOPsuccvfail_power_surrogates
...
for i_chDB = 4 : 4%length(chDB_list)
    ...
    for iSession = 1 : numSessions
        ...
        surr_STOPpower_metadata.freqBands = STOPmetadata.freqBands;
        ...
        surrogate_vecDiffmat_saveName = fullfile(subject_stopPowerDir, surrogate_vecDiffmat_saveName);
