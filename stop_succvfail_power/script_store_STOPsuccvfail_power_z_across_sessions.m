% script_store_STOPsuccvfail_power_z_across_sessions
...
%         
    ...
    for iSession = 1 : numSessions
        ...
        for iRegion = 1 : numRegions
            ...
            if max(abs(nanmean(sessionRegion_z,1))) < 5
    ...
    STOPpower_z_acrossSessions_metadata.numRegionSessions = numRegionSessions;
    ...
    subject_matName = [implantID '_power_stopSuccvFail_z.mat'];
    subject_matName = fullfile(subject_stopPowerDir,subject_matName);
    
    save(subject_matName, 'region_z', 'region_powerDiff', 'STOPpower_z_acrossSessions_metadata');
