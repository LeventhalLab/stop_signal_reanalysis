...
hilbert_directory = sprintf('/Volumes/PublicLeventhal1/dan/stop-signal reanalysis/Hilbert transformed LFP %d Hz bins', freq_band_width);
...
for i_chDB = 3 : length(chDB_list)
    ...
    for iSession = 1 : numSessions
        ...
        lfp_fileinfo = dir(['*_' sessionDate '*_spikeInterp.hsdf']);
